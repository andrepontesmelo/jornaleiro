...
# Test for country level journal
module Jornaleiro
  RSpec.describe '.JornalDOU' do
    let(:j) { JournalDOUFresh.new }

    it 'should parse a pdf file name' do
      parsed = j.parse_file 'DO3_2016_01_12.pdf?arg1=1eRJ1syC0L4 \
      DNPgeptgr7g&arg2=1452826103'
    ...
    it 'should clean the pdf file name' do
      cleaned = j.clean_file_name('DO1_2016_01_11_SuplementoAnvisa.pdf? \
        arg1=dADPwykoU_69iNuprCpnhA&arg2=1452823633')
